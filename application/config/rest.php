...
$config['rest_auth'] = 'basic'; //ini diubah
...
|
*/
$config['rest_enable_keys'] = true; ///ini diubah
...
|
*/
//$config['rest_key_column'] = 'key'; //ini diubah
$config['rest_key_column'] = 'my_key'; //ini diubah
