...
class PengajarControllerAdd extends REST_Controller
{
    ...
    public function AddPengajar_post()
    {
        ...
        $result = $pengajar->insertPengajar($data);

        if ($result > 0) {
            $this->response([
                'status' => true,
                'message' => 'NEW Pengajar Created'
            ], REST_Controller::HTTP_CREATED);
        } else {
            $this->response([
                'status' => false,
                'message' => 'FAILDE TO CREATE Pengajar'
